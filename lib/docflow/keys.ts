...
export const ACTIONS: Action[] = [
  ...
  { id: "stop", group: "Round vision", label: "Mark this line as a stop (or unmark it)", key: "alt+V", scope: "doc" },
  { id: "stop-next", group: "Round vision", label: "Next stop", key: "mod+]", scope: "any" },
  { id: "stop-prev", group: "Round vision", label: "Previous stop", key: "mod+[", scope: "any" },
  { id: "speak", group: "Round vision", label: "Speak through round vision", key: null, scope: "any" },
  ...[1, 2, 3, 4, 5, 6, 7, 8, 9].map((n) => ({ id: "stop-" + n, group: "Round vision", label: `Go to stop ${n}`, key: "alt+" + n, scope: "any" as Scope })),
  { id: "keep", group: "Rhetoric", label: "Keep the selected lines as rhetoric", key: "alt+S", scope: "doc" },
  { id: "import", group: "Rhetoric", label: "Paste a Google Doc of rhetoric", key: null, scope: "any" },
  { id: "rhetoric", group: "Page", label: "Show or hide the right panel", key: "alt+R", scope: "any" },
