...
/** What a cover title is written in. */
const COVER_BLUE = '#4a86e8';
...
function formatElements(src, o) {
  ...
  if (title) {
    // The cover reads blue in every file this is meant to match.
    out.push({ k: 'p', h: 'H1', al: 'center', bd: 1, runs: [{ t: title, b: true, fs: 26, fg: COVER_BLUE }] });
